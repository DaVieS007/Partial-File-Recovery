...
int main(int argc, char *argv[])
{
    ...
    if(argc < 3)
    {
        fprintf(stderr,"Usage: %s [source_file] [dest_file] [try = 1] [fill = 00] [skip = 1]\n\n",argv[0]);
        ...
        fprintf(stderr," - skip: (Optional) On read error skip the next (x) bytes\n\n");
        ...
        fprintf(stderr,"Example: %s /dev/sda /dev/sdb 2 00 512\n\n",argv[0]);
        return E_FAIL;
    }
